...
The date is split into a training size of 75%, and a dataset for testing of size 25% of the entire dataset. To optimize this algorithm, we are collecting the best value of k 'best_k', which is shown in the graph below:
